SE24 : class ya da interface oluþturma kodu
...
start-of-selection.
	create object gv_class. //degisken oluþturulunca obje olmasý için uygulama baþlatýlýnca derlenir
	
	gv_class->class_içindeki_fonksiyonlar ctrl + space yapýlýnca kod tamamlanýr


Eger metodumuz static ise classý oluþturmadan ve build etmeden sadece className=>static_fonk þeklinde eriþebiliriz
