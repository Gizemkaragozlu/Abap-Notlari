...
"Kolona ikon vermek için ve modfy işleyirle ugrasmamak için field symbol kullandık
LOOP AT gt_scarr ASSIGNING <GFS_SCARR>. "tablo içinde don fieldsembole ata bir değişiklik olursa modify etmeden otomatik olsun
<GFS_SCARR>-ICON = '@01@'. "daha sonra kolonun içine istenen icon id sini ver
ENDLOOP.
...
FORM SET_FCAT .
*
PERFORM CREATE_FCAT USING 'ICON' 'icon' 'icon' 'icon' 0 '' '' ''. "icon kolonu için
...
INCLUDE ZFC_ALV_OO_ALV_KULLANIM_TOP.
INCLUDE ZFC_ALV_OO_ALV_KULLAaNIM_PBO.
