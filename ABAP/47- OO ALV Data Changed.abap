...
FIELD-SYMBOLS: <gfs_fscarr> type scarr. "tabloya  ait fieldsymbol oluşturulur
...
call METHOD GO_ALV->REGISTER_EDIT_EVENT "Bu method alv içeirisndeki yaptıgım değişiklggii eventa haber etmeye saglar
  exporting
    I_EVENT_ID =       CL_GUI_ALV_GRID=>MC_EVT_ENTER.           " Event ID "mc_evt_enter  "Enter tuşuna bastıgım taktırde çalışmasını saglar
...
IF <GFS_FCATT>-FIELDNAME eq 'CARRNAME'. "Eger feld symbol içindeki dataların fieldname degeri carrıd ye eşitse
  <GFS_FCATT>-EDIT = abap_true. "field catalog '.'ndek' ed't modu aç
